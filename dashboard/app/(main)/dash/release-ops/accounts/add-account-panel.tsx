...
export function AddAccountPanel({ isOpen, onClose, onSuccess }: AddAccountPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/65 backdrop-blur-md animate-in fade-in duration-200 select-none">
      <div className="w-full max-w-lg bg-card border border-border rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-2 duration-200 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-foreground">Thêm Tài khoản Google Play Developer</h3>
              <p className="text-[11px] text-muted-foreground">Thêm Service Account Key & cấu hình hạn mức API</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-background border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 text-xs font-medium"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-background border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 text-xs font-mono"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="border border-dashed border-border rounded-xl p-4 bg-muted/20 text-center hover:border-primary/50 transition-colors relative cursor-pointer">
              <input
                type="file"
          ...
          <div className="pt-4 border-t border-border flex items-center justify-end gap-2">
            <button
              type="button"
              onClick={handleClose}
              className="px-4 py-2 font-semibold rounded-lg border border-border hover:bg-muted text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
            >
              Hủy
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 font-semibold rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
            >
